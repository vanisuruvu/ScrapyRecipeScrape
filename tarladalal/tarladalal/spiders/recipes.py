...
class RecipesSpider(scrapy.Spider):
    ...
    with open("C:/VANI/ScrapyProjects/tarladalal/tarladalal/spiders/AUrls.txt", "rt") as f:
    ...
    def parse(self, response):
        ...
        yield{
            ...
            'ingredients': response.xpath("//div[@id='rcpinglist']//a/span/descendant-or-self::*/text()").extract(),
